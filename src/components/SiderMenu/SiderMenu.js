...
//getFlatMenuKeys返回当前路由的pathname对应在flatMenuKeys中匹配项。例如当前pathname=’/dashboard/analysis’(有效路由)，则返回[‘/dashboard’,’/dashboard/analysis’]；当前pathname=’/aaa’(无效路由)，则返回[]，因为flatMenuKeys找不到匹配项
